...
def main():
    ...
    def update():
        ...
        print(f"{zoo.stats["nb_preys"]=} {zoo.stats["nb_predators"]=} {zoo.stats["mean_fitness_preys"]=} {zoo.stats["mean_fitness_predators"]=} {zoo.stats["generation"]=}, {zoo.stats["nb_deads"]=}")
