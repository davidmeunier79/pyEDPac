...
class EvoSimulation(Entity):
    def __init__(self, stats_path):
        ...
        self.multi_input_viz = MultiInputVisualizer(self.zoo.population, title = "EDPac inputs", scale = 3)
    ...
    def update(self):
        ...
        results = self.compute_perceptions_no_send(verbose=1)
    ...
    def compute_perceptions_no_send(self, verbose=0):
